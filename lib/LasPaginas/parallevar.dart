...
class ParaLlevarScreen extends StatelessWidget {
  const ParaLlevarScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Pedidos Para Llevar - DQ')),
      drawer: const DQDrawer(),
      body: Center(
        child: Image.network(
          'https://raw.githubusercontent.com/OmarMartinez0637/Imagenes-Para-DairyQueen/refs/heads/main/dqsanduish.png',
          width: 200,
          height: 200,
          fit: BoxFit.cover,
        ),
