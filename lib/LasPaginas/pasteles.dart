...
class PastelesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Pasteles Helados - DQ')),
      drawer: const DQDrawer(),
      body: Center(
        child: Image.network(
          'https://raw.githubusercontent.com/OmarMartinez0637/Imagenes-Para-DairyQueen/refs/heads/main/pastelchoco.png',
          width: 200,
          height: 200,
          fit: BoxFit.cover,
        ),
